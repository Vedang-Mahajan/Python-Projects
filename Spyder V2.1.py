...
while listening==1:
        ...
        elif "date" or "time" in command:
            print(response+ "Current Date and Time is: " +now.strftime("%d-%m-%y %H:%M:%S"))
            engine.say("Current Date and Time is: " +now.strftime("%d-%m-%y %H:%M:%S"))                                                                                                                                                                             
            engine.runAndWait()
