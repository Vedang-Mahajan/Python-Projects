...
music = {"alan walker alone" : "Alan Walker - Alone.mp3",
         ...
         "tribute remix" : "K-391, Alan Walker & Ahrix - End Of Time (Tribute Remix).mp3",
         "marshmello alone" : "Marshmello - Alone (Official Music Video).mp3",
         "marshmallow alone" : "Marshmello - Alone (Official Music Video).mp3"}
...
while listening == 1:
        ...
        elif "play" and "playlist" in command or "play" and "favourite playlist" in command:
            playsound("Alan Walker - Alone.mp3")
            playsound("K-391, Alan Walker & Ahrix - End Of Time (Tribute Remix).mp3")
            playsound("Marshmello - Alone (Official Music Video).mp3")
            
        elif "play" in command:
            command_new = command.lower()
            
            if command_new != music.keys():
                listening = 1
            else:
                song_name_split = command_new.split("play ", 1)
